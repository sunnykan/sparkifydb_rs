...
def drop_tables(cur, conn):
    """Drops all tables (if they exist) in the database"""
...
def create_tables(cur, conn):
    """Create all tables in the database including staging tables"""
...
def main():
    """Reads config file parameters and connects to database on Redshift"""
